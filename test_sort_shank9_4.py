            ...
            while j < len(unique_clu)-1:
                ...
                while con:
                    ...
                    for m in range(j+1, n):
                        x = prepare_features_test3(j, m, clu, mean_spk, std_spk, cc, time_mat, unique_clu,k)
...
# main_loop('/home/lidor/data/DBC/23_414_Kilosort_06_29_2022_08_32_20','1')
# import sys
# k = len(sys.argv)-1
# filebase = ''
# for i in range(k):
...
# # filebase = '/home/tali/Documents/mA234_35/npy_files'
# f = open(filebase + '/info')
# info = f.read()
# lst_info = info.split('\n')
